...
IMAGES_PATH = 'images'
IMAGE_NAME_TEMPLATE = 'Fotobox_Hochzeit_{0}.jpg'
CREATE_THUMBNAIL = False
THUMBNAIL_PATH = 'images/thumbnails'
THUMBNAIL_NAME_TEMPLATE = 'Hochzeit_{0}_thumb.jpg'
THUMBNAIL_WIDTH = '400'
...
def callback_helper(RFIN):
	# needed because callback-functions are not allowed to have more than one arg
	if IDLE:
...
def main():
	...
	GPIO.add_event_detect(RFIN, GPIO.RISING, callback=callback_helper, bouncetime=500)
